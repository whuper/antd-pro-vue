...

  {
    ...
    children: [
      ...
      // 新页面
      {
        ...
        name: 'newp',
        component: RouteView,
        redirect: '/newp/newpage',
        meta: { title: '新页面', icon: 'check-circle-o', permission: ['other1'] },
        children: [
          {
            path: '/newp/newpage',
            name: 'newpage',
            component: () => import('@/views/newp/newpage'),
            meta: { title: 'menu.profile.basic', permission: ['other1'] }
          }]
      },
